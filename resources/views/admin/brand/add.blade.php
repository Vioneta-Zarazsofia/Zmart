                                ...
                                <form action=""method="post">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label>Nama Brand<span style="color:red">*</span></label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="meta_title" required
                                                value="{{ old('meta_title') }}" placeholder="Meta Title"></input>
                                        </div>

                                        <div class="form-group">
                                            <label>Meta Description</label>
                                            <textarea type="text" class="form-control" name="meta_description" required value="{{ old('meta_description') }}"
