                                ...
                                <form action=""method="post">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label>Nama Biaya Pengiriman<span style="color:red">*</span></label>
                                            <input type="text" class="form-control" required value="{{ old('name') }}"
                                                name="name" placeholder="Shipping Charge Name">
                                        </div>

                                        <div class="form-group">
                                            <label>Harga <span style="color:red">*</span></label>
                                            <input type="text" class="form-control" required value="{{ old('price') }}"
