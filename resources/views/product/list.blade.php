...
@section('content')
    <main class="main">
        <div class="page-header text-center"
            style="background-image: url('{{ asset('assets ecom/images/page-header-bg.jpg') }}')">
            <div class="container">
                        ...
                        <div class="toolbox">
                            <div class="toolbox-left">
                                <div class="toolbox-info">
                                    Showing
                                    <span>
                                        {{ $getProduct->firstItem() ?? 0 }}-{{ $getProduct->lastItem() ?? 0 }}
                                        of {{ $getProduct->total() }}
                                    </span>
                                    Products
                                        ...
                                        <div class="widget-body">
                                            <div class="filter-items filter-items-count">
                                                @foreach ($getSubCategoryFilter as $f_category)
                                                    <div class="filter-item d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="filter-colors">
                                            @foreach ($getColor as $f_color)
                                                <a href="javascript:;" id="{{ $f_color->id }}" class="ChangeColor"
                                                    data-val="0" style="background: {{ $f_color->code }};"><span
...
@endsection
@section('script')
    <script src="{{ asset('assets ecom/js/wNumb.js') }}"></script>
    <script src="{{ asset('assets ecom/js/bootstrap-input-spinner.js') }}"></script>
    <script src="{{ asset('assets ecom/js/nouislider.min.js') }}"></script>
